...
#         self.total_loss = slim.losses.get_total_loss()
        ...
        self.confusing_images = tf.reshape(self.confusing_images, [-1, 224, 224, 3])
...
#     pre_processing = tf.placeholder(tf.float32, shape=[None, 224,224,3])
...
def train():    
    ...
    resnet.train(sess, X, y, Xt, yt, minibatch_size=10)
